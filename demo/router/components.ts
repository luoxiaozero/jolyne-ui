export const componentsRoutes = [
    ...
    {
        path: "image",
        component: () => import("../../src/image/demos/zhCN/index.entry.md")
    },
    {
        path: "input",
    ...
    {
        path: "message",
        component: () => import("../../src/message/demos/zhCN/index.entry.md")
    },
    {
        path: "modal",
    ...
    {
        path: "select",
        component: () => import("../../src/select/demos/zhCN/index.entry.md")
    },
    {
        path: "checkbox",
